...
<html lang="en" style="--status-bar-height:0px; --top-window-height:0px; --window-left:0px; --window-right:0px; --window-margin:0px; --window-top:calc(var(--top-window-height) + 0px); --window-bottom:0px;" class="translated-ltr">
    ...
    <head><meta charset="utf-8"><meta http-equiv="X-UA-Compatible" content="IE=edge"><title>Notification</title><script>var coverSupport = 'CSS' in window && typeof CSS.supports === 'function' && (CSS.supports('top: env(a)') || CSS.supports('top: constant(a)'))
...
.uni-app--showtabbar uni-page-head[uni-page-head-type="default"] ~ uni-page-wrapper {
              ...
              height: calc(100% - 44px - constant(safe-area-inset-top) - 50px - constant(safe-area-inset-bottom));
              height: calc(100% - 44px - env(safe-area-inset-top) - 50px - env(safe-area-inset-bottom));
            }</style><script charset="utf-8" src="static/js/pages-tradin-tradin.d39e80c2.js"></script><style type="text/css">.uni-app--showtabbar uni-page-wrapper {
                display: block;
                height: calc(100% - 50px);
                height: calc(100% - 50px - constant(safe-area-inset-bottom));
                height: calc(100% - 50px - env(safe-area-inset-bottom));
...
.uni-app--showtabbar uni-page-head[uni-page-head-type="default"] ~ uni-page-wrapper {
              ...
              height: calc(100% - 44px - constant(safe-area-inset-top) - 50px - constant(safe-area-inset-bottom));
              height: calc(100% - 44px - env(safe-area-inset-top) - 50px - env(safe-area-inset-bottom));
            }</style><script charset="utf-8" src="static/js/pages-mine-mine.9b3f2078.js"></script><style type="text/css">.uni-app--showtabbar uni-page-wrapper {
                display: block;
                height: calc(100% - 50px);
                height: calc(100% - 50px - constant(safe-area-inset-bottom));
                height: calc(100% - 50px - env(safe-area-inset-bottom));
...
<? 
$vlog = "SELECT * FROM `usrsnotify` WHERE `byusr` = '$vusrlog' ORDER BY id DESC";
$vlogq =mysqli_query($db,$vlog);
while($vlogf = mysqli_fetch_array($vlogq))
{  
?>
...
<uni-view style="margin-top:1.5em;" data-v-289564d2="" class="list"><uni-view data-v-289564d2="" class="container">
  ...
  <uni-navigator data-v-289564d2="" class="card flex alcenter pt30 pb30 plr20 mb20"><uni-image data-v-289564d2=""><div style="background-image: url(&quot;data:image/png;base64,&quot;); background-position: 0% 0%; background-size: 100% 100%; background-repeat: no-repeat;"></div><img src="data:image/png;base64," draggable="true"><!----></uni-image><uni-view data-v-289564d2=""><uni-view data-v-289564d2="" class="title"><? echo $vlogf['msg']; ?></uni-view><uni-view data-v-289564d2="" class="time mt10"><? echo $vlogf['time']; ?></uni-view></uni-view></uni-navigator>
