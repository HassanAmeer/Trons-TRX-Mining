...
.uni-app--showtabbar uni-page-head[uni-page-head-type="default"] ~ uni-page-wrapper {
      ...
      <!-----------for bar code -->
      <uni-view data-v-1409a1ee="" class="container flex-column alcenter"><uni-view data-v-1409a1ee="" style="color:gray;" class="mb20">Transfer to Promotion Account</uni-view><uni-view data-v-ea322ef6="" data-v-1409a1ee="" class="uqrcode"><uni-canvas data-v-ea322ef6="" canvas-id="qrcode_ukAvpQG26n2MZOAF9bvjpwcuZIVSQm2d" id="qrcode_ukAvpQG26n2MZOAF9bvjpwcuZIVSQm2d" style="width: 140px; height: 140px;">
