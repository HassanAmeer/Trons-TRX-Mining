...
<head><meta charset="utf-8"><meta http-equiv="X-UA-Compatible" content="IE=edge"><title>Change Password</title><script>var coverSupport = 'CSS' in window && typeof CSS.supports === 'function' && (CSS.supports('top: env(a)') || CSS.supports('top: constant(a)'))
...
.transfer-container[data-v-57037c46]{min-height:100vh;background-image:url(static/img/commonbg.36a8d8d.36a8d8de.jpg);background-size:100%}.transfer-container .main-container[data-v-57037c46]{background-color:#f0f3f7;border-radius:20px}.transfer-container .form-group[data-v-57037c46]{height:33px;color:#495057;border:1px solid #ced4da;border-radius:18px;background-color:#fff}.transfer-container .form-group uni-input[data-v-57037c46]{height:100%}.transfer-container .confirm-btn[data-v-57037c46]{height:33px;background-color:#ff2768;color:#fff;border-radius:24px}</style></head>
...
<body class="uni-body pages-mine-changeSecurityPassword"><noscript><strong>Please enable JavaScript to continue.</strong></noscript><uni-app class="uni-app--maxwidth"><uni-page data-page="pages/mine/changeSecurityPassword"><uni-page-head uni-page-head-type="default"><div class="uni-page-head" style="background-color: rgb(248, 248, 248); color: rgb(0, 0, 0);"><div class="uni-page-head-hd"><div class="uni-page-head-btn"><i onclick="history.back()" class="uni-btn-icon" style="color: rgb(0, 0, 0); font-size: 27px;"></i></div><div class="uni-page-head-ft"></div></div><div class="uni-page-head-bd"><div class="uni-page-head__title" style="font-size: 16px; opacity: 1;"><!----> Change Password </div></div><!----><div class="uni-page-head-ft"></div></div><div class="uni-placeholder"></div></uni-page-head><!----><uni-page-wrapper><uni-page-body><uni-view data-v-57037c46="" class="transfer-container"><uni-view data-v-57037c46="" class="main-container pd30"><uni-view data-v-57037c46="" class="form-group plr30 mb20"><uni-input data-v-57037c46="" minlength="6" class="ft28"><div class="uni-input-wrapper">
  
  
  <input maxlength="20" step="" enterkeyhint="done" id="oldpass" autocomplete="off" placeholder="Old Password" type="password" class="uni-input-input"><!----></div></uni-input></uni-view><uni-view data-v-57037c46="" class="form-group plr30 mb20"><uni-input data-v-57037c46="" minlength="6" class="ft28"><div class="uni-input-wrapper">
    <input maxlength="20" id="setnewpass" step="" placeholder="New Password" enterkeyhint="done" autocomplete="off" type="password" class="uni-input-input"><!----></div></uni-input></uni-view><uni-view data-v-57037c46="" class="form-group plr30 mb20"><uni-input data-v-57037c46="" minlength="6" class="ft28"><div class="uni-input-wrapper">
...
/////////////// ///////////////
 ...
 //var setnewpass = $('#setnewpass').val();
   var setokpass = $('#setokpass').val();
   
  if(oldpass == "" || setokpass == "")
   {
     $('.redpopup').fadeIn();
     $('.popinerred').html('× All feilds are required');
      ...
      $.post(
      "jaxo1.php",
   {oldpassjs:oldpass,setokpassjs:setokpass},
   function(chksetf){
   if(chksetf == 1){
       $('.bluepopup').fadeIn();
  $('.popinerblue').html(' Ok Updates ');
     }else if(chksetf == 0){
      $('.redpopup').fadeIn();
     $('.popinerred').html(' Old password not Matched');
     }else if(chksetf == 2){
      $('.redpopup').fadeIn();
