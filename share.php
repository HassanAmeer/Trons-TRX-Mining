...
<head><meta charset="utf-8"><meta http-equiv="X-UA-Compatible" content="IE=edge"><title>share</title><script>var coverSupport = 'CSS' in window && typeof CSS.supports === 'function' && (CSS.supports('top: env(a)') || CSS.supports('top: constant(a)'))
...
-webkit-transform:translateY(-100%);transform:translateY(-100%)}.slide-top-active[data-v-016ede03]{-webkit-transform:translateY(0);transform:translateY(0)
}.slide-right-in[data-v-016ede03]{-webkit-transform:translateX(100%);transform:translateX(100%)}.slide-right-active[data-v-016ede03]{-webkit-transform:translateX(0);transform:translateX(0)}.slide-bottom-in[data-v-016ede03]{-webkit-transform:translateY(100%);transform:translateY(100%)}.slide-bottom-active[data-v-016ede03]{-webkit-transform:translateY(0);transform:translateY(0)}.slide-left-in[data-v-016ede03]{-webkit-transform:translateX(-100%);transform:translateX(-100%)}.slide-left-active[data-v-016ede03]{-webkit-transform:translateX(0);transform:translateX(0);opacity:1}.zoom-in-in[data-v-016ede03]{-webkit-transform:scale(.8);transform:scale(.8)}.zoom-out-active[data-v-016ede03]{-webkit-transform:scale(1);transform:scale(1)}.zoom-out-in[data-v-016ede03]{-webkit-transform:scale(1.2);transform:scale(1.2)}</style><style type="text/css">@charset "UTF-8";
...
.uni-app--showtabbar uni-page-head[uni-page-head-type="default"] ~ uni-page-wrapper {
        ...
        <script charset="utf-8" src="static/js/pages-home-recharge~pages-investlist-recharge~pages-share-share.023c252f.js"></script>
        <script charset="utf-8" src="static/js/pages-share-share.6c72646c.js"></script>
...
.share-container[data-v-8542b28e]{min-height:100vh;padding-bottom:85px;background-image:url(static/img/sharebg.4652715.4652715f.jpg);background-color:#f6f7fa;background-size:100%;box-sizing:border-box}.share-container .header-icon[data-v-8542b28e]{position:relative;width:30px;height:30px;background:#f5c7eb;border-radius:50%;margin-left:3px}.share-container .header-icon uni-image[data-v-8542b28e]{width:21px;height:21px}.share-container .header-icon .counter[data-v-8542b28e]{width:6px;height:6px;border-radius:4px;background-color:#dc3545;position:absolute;top:0;right:0;margin-top:5px;margin-right:2px}.share-container .head-dropdown[data-v-8542b28e]{position:fixed;padding:0;background-color:#fe6ea2;z-index:999;width:80px;line-height:38px;top:50px;right:0;border-bottom-left-radius:4px;border-bottom-right-radius:4px;font-size:12px;text-align:center;color:#fff}.share-container .shre_content[data-v-8542b28e]{width:100%;position:relative;padding-top:80px;background-image:url(static/img/sharebg.4652715.4652715f.jpg);background-size:100%}.share-container .shre_content .font_grow[data-v-8542b28e]{margin-top:50px;height:145px}.share-container .shre_content .font_grow .title[data-v-8542b28e]{text-align:center;font-size:25px;color:#2a2a2a;font-weight:700;margin-bottom:7px}.share-container .shre_content .font_grow .des[data-v-8542b28e]{font-size:14px;color:#2a2a2a;text-align:center}.share-container .shre_content .qrcode[data-v-8542b28e]{width:107px;height:240px;margin:0 auto;display:flex;justify-content:center}.share-container .shre_content .copy[data-v-8542b28e]{width:340px;height:44px;padding:0 5px 0 21px;background:rgba(247,249,253,.9);border-radius:20px;margin:0 auto;box-sizing:border-box}.share-container .shre_content .copy .invite-link[data-v-8542b28e]{flex:1;font-size:11px;color:#2a2a2a;word-break:break-all;margin-right:10px;box-sizing:border-box}.share-container .shre_content .copy .copy-btn[data-v-8542b28e]{flex-shrink:0;width:89px;height:37px;border-radius:20px;background:linear-gradient(90deg,#fe8bb8,#eb4068);font-size:13px;color:#fff}.share-container .shre_content .refer[data-v-8542b28e]{width:335px;height:85px;background-image:url(static/img/shareicon_07.114db29.114db291.png);background-size:100% 100%;margin:15px auto 0;padding-left:100px;padding-top:20px;font-size:17px;color:#2a2a2a;margin-bottom:10px;font-weight:700;box-sizing:border-box}.share-container .shre_content .refer uni-text[data-v-8542b28e]{display:block;font-size:9px;color:#ef5079}.share-container .footer[data-v-8542b28e]{position:fixed;left:50%;bottom:25px;display:flex;width:340px;height:94px;align-items:center;justify-content:space-between;padding:0 12px;-webkit-transform:translateX(-50%);transform:translateX(-50%);background-image:url(static/images/footerbg.png);background-size:100% 100%}.share-container .footer .item[data-v-8542b28e]{padding-top:39px}.share-container .footer .mid[data-v-8542b28e]{width:62px;height:100%;position:absolute;bottom:0;left:50%;-webkit-transform:translateX(-35%);transform:translateX(-35%)}.share-container .footer .tabbar[data-v-8542b28e]{width:37px;margin:0 10px;height:40px;background-size:100% 100%}.share-container .footer .tabbar uni-view[data-v-8542b28e]{width:100%;height:100%;padding-top:25px;font-size:13px;color:#c6ccd3;text-align:center;box-sizing:border-box;overflow:hidden}.share-container .footer .tabbar uni-view.active[data-v-8542b28e]{color:#ff2768}</style></head>
...
<body class="uni-body pages-share-share"><uni-app class="uni-app--maxwidth"><uni-page data-page=""><!----><!----><uni-page-wrapper><uni-page-body><uni-view data-v-8542b28e="" class="share-container"><uni-view data-v-8542b28e="" class="flex-between alcenter h110 plr30"><uni-view data-v-8542b28e=""></uni-view><uni-view data-v-8542b28e="" class="flex alcenter">
 ...
 <!--------qrcode link ------>
  ...
  { var selectto = document.getElementById("copyreflinkjs");
   ...
   document.getElementById("copyrefbtn").style.color = "pink";
   document.getElementById("copyrefbtn").style.background = "rgba(148,0,0,0.902)";
   document.getElementById("copyrefbtn").style.border = "4px solid pink";
